      ...
      <div className="flex justify-end items-center">
        <div className="flex flex-col gap-8 items-center text-center lg:items-start lg:text-left text-align:ceter">
          <h1 className="custom-text dark:d-text text-3xl tracking-widest md:text-4xl lg:text-5xl font-semibold">
            Funding futures,{" "}
            <span className={`${protanopia ? "custom-green-pt" : deuteranopia ? "custom-green-dt" : tritanopia ? "custom-green-tr" : "custom-green"}`}>changing lives</span>.
          </h1>
          ...
          <button className={`text-white py-2 px-4 rounded ${protanopia ? "custom-green-background-pt" : deuteranopia ? "custom-green-background-dt" : tritanopia ? "custom-green-background-tr" : "custom-green-background"}`}>
            <Link href="/signup">
              Register
            </Link>
          </button>

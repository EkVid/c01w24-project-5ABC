      ...
      <div className="flex flex-col items-center lg:grid lg:grid-cols-3">
        ...
        <div className="flex flex-col items-center mt-10 lg:min-h-full"> 
          ...
          <QuoteCard 
            img={DevelopmentIcon} 
            title={"Development"} 
            content={"Developing technology supports that promote inclusion and provide meaningful opportunities for marginalized individuals to reach their full potential."}
          />
        </div>
        <div className="flex flex-col items-center mt-10 lg:min-h-full"> 
          ...
          <QuoteCard 
            ...
            title={"Accomodation"} 
            content={"Ensuring that all people have access to the same resources and opportunities regardless of their abilities by efficiently providing workplace accommodations."}
          />
        </div>
      </div>
    </div>

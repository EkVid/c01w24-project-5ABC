...
export default function ViewGrant({ grant, setViewGrant }){
    ...
    return (
        <>
            ...
            <div tabIndex="0" className="flex md:flex-row flex-col items-top ms-4 mb-10">
            ...
            <div className="w-fullflex-col items-center ms-4 mb-10">
                <p tabIndex="0" className="self-start md:self-auto dark:d-text">Application Form:</p>
            ...
            <div className="flex flex-col items-top ms-4 mb-20">
                <p tabIndex="0" className="w-full pt-2 dark:d-text">Grantee Profile - Your ideal applicant: </p>
                <div 
                ...
                >
                    <div tabIndex="0" className="flex flex-col my-2">
